...
```console
gh attestation verify <path_to_the_release_artifact> --repo whiteprints-tests/test-rtd-linux-py313-test
```
...
cosign verify-blob \
    ...
    --certificate-identity-regexp="^https://github.com/whiteprints-tests/test-rtd-linux-py313-test/.github/workflows/upload_artifacts.yml?" \
