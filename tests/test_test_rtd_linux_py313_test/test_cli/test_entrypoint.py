...
from test_rtd_linux_py313_test import package_metadata
from test_rtd_linux_py313_test.cli import __app_name__, entrypoint
...
class TestCLI:
    ...
    def test_version(cli_runner: testing.CliRunner) -> None:
        ...
        result = cli_runner.invoke(
            entrypoint.test_rtd_linux_py313_test,
            ["--version"],
        )
    ...
    def test_default(cli_runner: testing.CliRunner) -> None:
        ...
        Args:
            cli_runner: the CLI test runner provided by typer.testing or a
                fixture.
        """
        result = cli_runner.invoke(entrypoint.test_rtd_linux_py313_test)
        assert result.exit_code == 0, "The CLI did not exit properly."
