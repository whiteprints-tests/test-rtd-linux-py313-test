...
from test_rtd_linux_py313_test import __version__
from test_rtd_linux_py313_test.cli import APP_NAME, __app_name__
from test_rtd_linux_py313_test.cli.logs import LogLevel, configure_logging
from test_rtd_linux_py313_test.loc import _


__all__: Final = ["test_rtd_linux_py313_test"]
...
def print_copyright(ctx: Context, _param: Option, value: bool) -> None:
    ...
    console = importlib.import_module("test_rtd_linux_py313_test.console")
...
def print_license(ctx: Context, _param: Option, value: bool) -> None:
    ...
    package_metadata = importlib.import_module(
        "test_rtd_linux_py313_test.package_metadata"
    )
    console.STDOUT.print(
...
def print_debug_info(ctx: Context, _param: Option, value: bool) -> None:
    ...
    console.STDOUT.print(
        importlib.import_module(
            "test_rtd_linux_py313_test.debug_info",
            __package__,
        ).gather_debug_info()
    )
    ctx.exit()
...
def test_rtd_linux_py313_test(**kwargs: Unpack[CLIArgsType]) -> None:
    """The Whiteprint CLI."""
    configure_logging(
